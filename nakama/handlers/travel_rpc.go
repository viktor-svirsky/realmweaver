...
func RPCTravel(ctx context.Context, logger runtime.Logger, db *sql.DB, nk runtime.NakamaModule, payload string) (string, error) {
	...
	// Travel narrative will be generated by the match handler via travel_complete action
	// using Claude with the player's language setting
	resp := TravelResponse{
		Region:     region,
		TravelTime: travelTime,
		Narrative:  fmt.Sprintf("Traveling to %s...", region.Name),
		NPCs:       npcs,
	}
